...
urlpatterns = [
    ...
    # NOUVEAU : Indices de sécheresse historique (VCI / TCI / VHI / NCWSI) basés sur MODIS
    # - Mode zone administrative (region | prefecture | commune)
    path('api/drought-indices/', views.drought_indices, name='drought_indices'),
    # - Mode champ utilisateur
    path('api/field-drought-indices/', views.field_drought_indices, name='field_drought_indices'),
